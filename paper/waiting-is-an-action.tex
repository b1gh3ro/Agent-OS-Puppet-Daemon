...
\S\ref{sec:rq1} reports the cost--latency experiment and \S\ref{sec:rq3} the
deployment observations; both are backed by data. \S\ref{sec:rq2}'s
threshold sweep is the one protocol still to run, and is marked as such.
