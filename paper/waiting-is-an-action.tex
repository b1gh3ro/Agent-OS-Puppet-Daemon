...
and $92\%$ of the time. The rare miss is the eager detector's failure mode: a wake
on incidental motion that the model acts on before the true event, or a
below-threshold signal. It is the price of the $O(1)$ cost.
