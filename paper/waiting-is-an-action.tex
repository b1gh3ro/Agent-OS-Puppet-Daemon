...
those logs --- never message content --- and \textbf{withhold the raw logs
entirely}; the released artifact comprises the code and the synthetic task suite
alone. The motivating example opening Section~\ref{sec:intro} is synthetic for
the same reason.
